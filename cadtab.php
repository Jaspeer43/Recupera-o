...
<div class="margem">
    <div class="form">
        ...
        <h3>Insira os dados</h3>
            ...
            <p>Lado:</p>
                <input class="form-control btn-sm" name="Tablado" id="Tablado" type="text" required="true" value="<?php if ($processa1 == "editar") echo $dados['Tablado']; ?>"><br>         
            
            <button name="processa1" value="salvar" id="processa1" type="submit" class="btn btn-outline-info">Salvar</button>
            </form>
</div>
</div>
</body>
