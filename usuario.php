...
<div class="margem">
    <div class="form">
        <form method="post" action="processa2.php">
            <h3>Novo Usuário:</h3><hr>
            <input type="hidden" name="idUsuario" id="idUsuario" size="25" value="0">
            <p>Nome:</p><input type="text" name="nome" id="nome" size="25" value="" class="form-control btn-sm"><br>
            <p>Login:</p><input type="text" name="login" id="login" size="25" value="" class="form-control btn-sm"><br>
            <p>Senha:</p><input type="password " name="senha" id="senha" size="25" value="" class="form-control btn-sm"><hr>
            <button name="processa2" id="processa2" value="salvar" type="submit"  class="btn btn-outline-info">Salvar</button>
            <br>
        </form>
    </div>
    <br>
    ...
    <h3>Procurar Usuário</h3>
        ...
        <p> Pesquisar por:</p>
                ...
                <input type="radio" name="tipo" value="2" class="form-check-input" <?php if ($tipo == "2") echo "checked" ?>>Nome<br><br>
    ...
    <div>
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td><a href='cadus.php?processa2=editar&idUsuario=<?php echo $linha['idUsuario'];?>'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
          <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
          <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
        </svg></a></td>
                    <td><?php echo " <a href='processa2.php?processa2=excluir&idUsuario={$linha['idUsuario']}')>";?><?php echo " <a href='processa2.php?processa2=excluir&idUsuario={$linha['idUsuario']}')>";?><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
